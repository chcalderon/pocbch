...
object process_activos1_mes { 
 ...
 var FileName = "hdfs://cluster-b54a-m/bancochile/gdd/data/raw/cmf/GDD_cmf_Activos_Bancos_1_".concat(param_year.toString).concat(param_month.toString)
...
//Df2.show()
      ...
      /*********************************************************/ 
        Control.NewStep("Masterizacion de tbl_activospoc1_mes") 
        val huemulTable_tbl_activos1_mes = new tbl_activospoc1_messys(huemulBigDataGov,Control) 
       

	//  huemulTable_tbl_activos1_mes.DF_from_SQL("TBL_ACTIVOS1_mes","""SELECT * FROM df_final""") 
 	huemulTable_tbl_activos1_mes.DF_from_SQL("TBL_ACTIVOSPOC1_MESSYS",s"""SELECT row_number() over (order by idx) as id_interfaz,* FROM df_final""") 
